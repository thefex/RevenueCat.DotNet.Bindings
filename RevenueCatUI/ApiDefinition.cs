...
namespace RevenueCatUI {
	...
	interface RCCustomerCenterViewControllerDelegate {
		...
		void CustomerCenterViewControllerDidCompleteRefundRequest (RCCustomerCenterViewController controller, string productId, RCRefundRequestStatus status);
		...
		void CustomerCenterViewControllerDidCompleteFeedbackSurvey (RCCustomerCenterViewController controller, string optionId);
		...
		void CustomerCenterViewControllerDidSelectChangePlans (RCCustomerCenterViewController controller, string optionId);
	...
	interface RCPaywallViewController {
		...
		NativeHandle Constructor ([NullAllowed] RCOffering offering, bool displayCloseButton, bool shouldBlockTouchEvents, [NullAllowed] NSObject purchaseHandler, [NullAllowed] Action<RCPaywallViewController> dismissRequestedHandler);
	...
	interface RCPaywallFooterViewController {
		...
		[DesignatedInitializer]
		NativeHandle Constructor ([NullAllowed] RCOffering offering, [NullAllowed] NSObject purchaseHandler, [NullAllowed] Action<RCPaywallViewController> dismissRequestedHandler);
...
*/
	...
	interface RCPaywallViewControllerDelegate {
		...
		void PaywallViewControllerDidFinishRestoring (RCPaywallViewController controller, RCCustomerInfo customerInfo);
		...
		void PaywallViewControllerDidFailRestoring (RCPaywallViewController controller, NSError error);
		...
		void PaywallViewControllerDidChangeSize (RCPaywallViewController controller, CGSize size);
		...
		void PaywallViewControllerWillPresentExitOffer (RCPaywallViewController controller, RCPaywallViewController exitOfferController);
	...
	// @interface RevenueCatUI_Swift_705 (RCPurchases) — web checkout paywall presentation (5.84.0)
	[Category]
	[BaseType (typeof (RCPurchases))]
	interface RCPurchases_RevenueCatUI_WebCheckout {
		...
		bool PresentPaywallFromWindow (NSUrl url, [NullAllowed] UIWindow window);
		...
		bool PresentPaywallFromScene (NSUrl url, [NullAllowed] UIWindowScene scene);
