...
namespace RevenueCat {
	...
	interface RCCustomerInfo {
		...
		NSDictionary SubscriptionsByProductIdentifier { get; }
	...
	interface RCEntitlementInfos_RevenueCat_Swift_1517 {
		...
		NSDictionary ActiveInCurrentEnvironment { get; }
...
*/
	...
	interface RCPurchasesType {
		...
		void GetProductsWithIdentifiers (string [] productIdentifiers, Action<NSArray> completion);
		...
		void Products (string [] productIdentifiers, Action<NSArray> completionHandler);
		...
		void CheckTrialOrIntroDiscountEligibility (string [] productIdentifiers, Action<NSDictionary> receiveEligibility);
		...
		void CheckTrialOrIntroDiscountEligibilityWithProductIdentifiers (string [] productIdentifiers, Action<NSDictionary> completionHandler);
		...
		void EligiblePromotionalOffersForProduct (RCStoreProduct product, Action<NSArray> completionHandler);
	...
	interface RCPurchases_RevenueCat_Swift_3363 {
		...
		void CheckTrialOrIntroductoryPriceEligibility (string [] productIdentifiers, Action<NSDictionary> completion);
		...
		[Obsoleted (PlatformName.MacOSX, 1, 0, message: "'automaticAppleSearchAdsAttributionCollection' has been renamed to 'Purchases.shared.attribution.enableAdServicesAttributionTokenCollection()':  Use Purchases.shared.attribution.enableAdServicesAttributionTokenCollection() instead. AdClient doesn't work after February 7, 2023  so this boolean doesn't have any effect. ")]
		[Obsoleted (PlatformName.WatchOS, 1, 0, message: "'automaticAppleSearchAdsAttributionCollection' has been renamed to 'Purchases.shared.attribution.enableAdServicesAttributionTokenCollection()':  Use Purchases.shared.attribution.enableAdServicesAttributionTokenCollection() instead. AdClient doesn't work after February 7, 2023  so this boolean doesn't have any effect. ")]
		[Obsoleted (PlatformName.TvOS, 1, 0, message: "'automaticAppleSearchAdsAttributionCollection' has been renamed to 'Purchases.shared.attribution.enableAdServicesAttributionTokenCollection()':  Use Purchases.shared.attribution.enableAdServicesAttributionTokenCollection() instead. AdClient doesn't work after February 7, 2023  so this boolean doesn't have any effect. ")]
		[Obsoleted (PlatformName.iOS, 1, 0, message: "'automaticAppleSearchAdsAttributionCollection' has been renamed to 'Purchases.shared.attribution.enableAdServicesAttributionTokenCollection()':  Use Purchases.shared.attribution.enableAdServicesAttributionTokenCollection() instead. AdClient doesn't work after February 7, 2023  so this boolean doesn't have any effect. ")]
		[Static]
	...
	interface RCPurchases_RevenueCat_Swift_3553 {
		...
		[Export ("checkTrialOrIntroDiscountEligibility:completion:")]
		void CheckTrialOrIntroDiscountEligibility (string [] productIdentifiers, Action<NSDictionary> completion);
