...
SWIFT_ENUM_FWD_DECL(NSInteger, RCPurchasesAreCompletedBy)
SWIFT_ENUM_FWD_DECL(NSInteger, RCStoreKitVersion)
@class NSUserDefaults;
@class RCDangerousSettings;
@class RCPlatformInfo;
SWIFT_ENUM_FWD_DECL(NSInteger, RCEntitlementVerificationMode)
...
/// You can present this yourself, or use <code>UIViewController.presentDebugRevenueCatOverlay</code>
/// for a default presentation using <code>UISheetPresentationController</code>.
/// seealso:
/// <code>View.debugRevenueCatOverlay</code> for <code>SwiftUI</code>.
SWIFT_CLASS_NAMED("DebugViewController") SWIFT_AVAILABILITY(ios,introduced=16.0)
@interface RCDebugViewController : UIViewController
...
SWIFT_ENUM_FWD_DECL(NSInteger, RCPeriodType)
SWIFT_ENUM_FWD_DECL(NSInteger, RCStore)
SWIFT_ENUM_FWD_DECL(NSInteger, RCPurchaseOwnershipType)
SWIFT_ENUM_FWD_DECL(NSInteger, RCVerificationResult)
...
SWIFT_ENUM_FWD_DECL(NSInteger, RCIntroEligibilityStatus)
...
SWIFT_ENUM_FWD_DECL(NSInteger, RCPackageType)
...
/// \param types An <code>NSSet</code> containing items representing store message types.
/// Each item should be either a <code>StoreMessageType</code> (backed by <code>NSNumber</code>) or an <code>NSNumber</code>
/// representing the raw value of a <code>StoreMessageType</code>.
///
...
/// For entitlements granted via the Galaxy Store.
  RCGalaxy SWIFT_COMPILE_NAME("galaxy") = 11,
};
...
SWIFT_ENUM_FWD_DECL(NSInteger, RCStoreProductType)
SWIFT_ENUM_FWD_DECL(NSInteger, RCStoreProductCategory)
...
SWIFT_ENUM_FWD_DECL(NSInteger, RCPaymentMode)
SWIFT_ENUM_FWD_DECL(NSInteger, RCDiscountType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, RCSubscriptionPeriodUnit)
...
@interface UIViewController (SWIFT_EXTENSION(RevenueCat))
/// Presents a bottom sheet overlay on top of the current view controller
/// which allows debugging the current SDK setup.
/// seealso:
/// <code>DebugViewController</code>.
/// seealso:
/// <code>View.debugRevenueCatOverlay</code> for <code>SwiftUI</code>.
- (void)rc_presentDebugRevenueCatOverlayAnimated:(BOOL)animated;
@end
